"""Tests for statick_tool.statick_plugin."""
import argparse
import os
...
def test_statick_plugin_load_mapping_valid():
...
def test_statick_plugin_load_mapping_invalid():
...
def test_statick_plugin_load_mapping_missing():
...
def test_statick_plugin_load_mapping_suffixed():
...
def test_statick_plugin_load_mapping_suffixed_fallback():
